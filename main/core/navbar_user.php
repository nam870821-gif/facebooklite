...
<i class="fas fa-arrow-left trolai headmb m-auto" id="seacrh-icon"></i>
...
<!-- /./ -->
  <button class="navbar-toggler mobilesearch" type="button" data-toggle="collapse" data-target="#navbarSupportedContent-555"
    aria-controls="navbarSupportedContent-555" aria-expanded="false" aria-label="Toggle navigation">
  <span><input class="form-control timkiemmb" type="text" placeholder="Tìm kiếm"></span>
  </button>
<!-- /./ -->
               ...
               function getTinnhan(){
                 $.post("API/api_thongbao.php",{ type: "MESS" },function(data){
                    ...
                    for(var i=0; i<Data.length; i++){
                      ...
                      if(Data.length < 4){
                        $("#tin-nhan").css('height','258px').css('overflow','auto');
     ...
     <li class="nav-item dropdown mg">
         ...
         <!-- /./ -->
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle waves-effect waves-light bongbong" id="navbarDropdownMenuLink" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false"><i class="sp_wx0RG-EYGDH"></i></a>
            <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink" id="tuy-chon" style="display:">
              ...
              <a class="dropdown-item" data-toggle="modal" data-target="#donggop">
                ...
                <div class="col-md-10 menu-icon">Đóng góp ý kiến<br/><small>Góp phần cải thiện blog của Kunloc</small></div>
                </div>
             </a>
              <b class="cach"><hr></b>
