(function(i) {
    ...
    var B = {
            "_rels/.rels": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="../../../schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>',
        ...
        action: function(a, b, d, c) {
            ...
            if (l.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    d.remove();
                    if (h) {
                        b.buttons.info(b.i18n("buttons.copyTitle", "Sao chép tạm thời"), b.i18n("buttons.copySuccess", {
                            1: "Sao chép một hàng vào clipboard",
                            _: "Đã sao chép %d bảng"
                        }, a.rows), 2E3);
                        this.processing(!1);
                        return
                    }
            ...
            h = i("<span>" + b.i18n("buttons.copyKeys", "Nhấn <i>ctrl</i> or <i>⌘</i> + <i>C</i> để sao chép dữ liệu bảng <br> vào bảng tạm hệ thống của bạn.<br><br>Để hủy, bấm vào tin nhắn này hoặc nhấn thoát.") +
                "</span>").append(d);
            b.buttons.info(b.i18n("buttons.copyTitle", "Sao chép tạm thời"), h, 0);
            c[0].focus();
            c[0].select();
