...
$db_username = "tovnonlinecom_baonews";
$db_password = "tovnonlinecom_baonews";
$host_name = "localhost";
$db_name = 'tovnonlinecom_baonews';
...
$tieude = "Kunloc";
$content = "Kunloc";
$domain_url = "https://dichvufbvn.net/";
$subdomain = "https://dichvufbvn.net/";
...
$password_momo = 'utkghzfnictjgbzg'; #password email có liên kết MOMO
$value_momo = 30; #Số ngày cần get giao dịch
#$lich_su_dang_nhap = mysqli_fetch_object(mysqli_query($kunloc,"SELECT * FROM lich_su_dang_nhap WHERE username = '$username' "));
$today = date("h:i:s");
$now = time();
$time_swal = 1000;
#-------GET IP PROXY------------
